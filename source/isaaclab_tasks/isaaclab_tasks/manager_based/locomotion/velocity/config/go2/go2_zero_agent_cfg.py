...
from isaaclab.sensors import ContactSensorCfg, RayCasterCfg, RayCasterLidarCfg, RayCasterBoxCfg, ImuCfg, patterns
...
##
from isaaclab.terrains.config.image_heightfield import IMAGE_STAIRS_TERRAIN_CFG  # isort: skip
from isaaclab.terrains.config.image_heightfield import MULTI_LAYER_TERRAIN_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=MULTI_LAYER_TERRAIN_CFG,
