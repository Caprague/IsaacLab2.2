...
##
from omni.isaac.lab.terrains.config.rough_user import SKILL_CLIMP_TERRAINS_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=SKILL_CLIMP_TERRAINS_CFG,
...
class CommandsCfg:
    ...
    # base_velocity = mdp.UniformVelocityCommandWorldCfg(
    #     asset_name="robot",
    #     resampling_time_range=(25.0, 25.0),
    #     rel_standing_envs=0.05,
    #     rel_heading_envs=1.0,
    #     heading_command=True,
    #     inv_heading_command=False,
    #     heading_control_stiffness=0.5,
    #     debug_vis=True,
    #     ranges=mdp.UniformVelocityCommandWorldCfg.Ranges(
    #         lin_vel_x=(-1.0, 1.0), lin_vel_y=(-1.0, 1.0), ang_vel_z=(-1.0, 1.0), heading=(-math.pi / 4.0, math.pi / 4.0)
    #     ),
    # )

    base_velocity = mdp.UniformVelocityCommandCfg(
        asset_name="robot",
        resampling_time_range=(10.0, 25.0),
        rel_standing_envs=0.05,
        rel_heading_envs=1.0,
        heading_command=True,
        heading_control_stiffness=0.5,
        ...
        # ranges=mdp.UniformVelocityCommandCfg.Ranges(
        #     lin_vel_x=(0.5, 1.5), lin_vel_y=(-0.3, 0.3), ang_vel_z=(-1.0, 1.0), heading=(-math.pi / 4.0, math.pi / 4.0)
        # ),
    )
...
class RewardsCfg:
    ...
    base_height_l2 = RewTerm(
        ...
        weight=-3.0,
        params={"height_gap_target": 0.25, "diff_range": 0.08, "asset_cfg": SceneEntityCfg("robot", body_names="base")},
    )
    # 默认站立姿态 [姿态]
    ...
    # 足端滞空最大偏差惩罚
    feet_air_max_devia = RewTerm(
        func=mdp.feet_air_max_devia,
        weight=-0.5,
...
class Go2LocomotionSkillEnvCfg_Play(Go2LocomotionSkillEnvCfg):
    def __post_init__(self) -> None:
        ...
        self.terminations.time_out.time_out = 60
